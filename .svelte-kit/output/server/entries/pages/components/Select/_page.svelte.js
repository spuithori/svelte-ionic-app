...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Ionic Companion - Select</title>`, ""}`, ""}
...
${validate_component(IonPage, "IonPage").$$render($$result, {}, {}, {
    default: () => {
      return `<ion-header translucent="${"true"}"><ion-toolbar><ion-buttons slot="${"start"}"><ion-menu-button></ion-menu-button></ion-buttons>
			<ion-buttons slot="${"end"}">${validate_component(SourceButton, "SourceButton").$$render($$result, { name: "Select" }, {}, {})}</ion-buttons>
			<ion-title>Select</ion-title></ion-toolbar></ion-header>

	<ion-content fullscreen><ion-list><ion-item><ion-label>Pet</ion-label>
				<ion-select><ion-select-option value="${"cat"}">Cat</ion-select-option>
					<ion-select-option value="${"dog"}">Dog</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Gaming</ion-label>
				<ion-select interface="${"popover"}"><ion-select-option value="${"nes"}">NES</ion-select-option>
					<ion-select-option value="${"n64"}">Nintendo64</ion-select-option>
					<ion-select-option value="${"ps"}">PlayStation</ion-select-option>
					<ion-select-option value="${"genesis"}">Sega Genesis</ion-select-option>
					<ion-select-option value="${"saturn"}">Sega Saturn</ion-select-option>
					<ion-select-option value="${"snes"}">SNES</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Notifications</ion-label>
				<ion-select value="${"notifications"}" interface="${"action-sheet"}"><ion-select-option value="${"enable"}">Enable</ion-select-option>
					<ion-select-option value="${"mute"}">Mute</ion-select-option>
					<ion-select-option value="${"mute_week"}">Mute for a week</ion-select-option>
					<ion-select-option value="${"mute_year"}">Mute for a year</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Operating System</ion-label>
				<ion-select ok-text="${"Okay"}" cancel-text="${"Nah"}"><ion-select-option value="${"dos"}">DOS</ion-select-option>
					...
					<ion-select-option value="${"win98"}">Windows 98</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Music</ion-label>
				<ion-select value="${"nirvana"}"><ion-select-option>Alice in Chains</ion-select-option>
					...
					<ion-select-option>Stone Temple Pilots</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Month</ion-label>
				<ion-select value="${"12"}"><ion-select-option value="${"01"}">January</ion-select-option>
					...
					<ion-select-option value="${"12"}">December</ion-select-option></ion-select></ion-item>

			<ion-item><ion-label>Year</ion-label>
				<ion-select value="${"1994"}"><ion-select-option>1989</ion-select-option>
					...
					<ion-select-option>1999</ion-select-option></ion-select></ion-item></ion-list></ion-content>`;
    }
  })}`;
});
export {
