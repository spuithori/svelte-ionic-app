...
const app_template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\r\n<html lang="en">\r\n\r\n<head>\r\n	<meta charset="utf-8" />\r\n	<link rel="icon" href="' + assets2 + `/favicon.png" />\r
	...
	<meta name="viewport"\r
		content="viewport-fit=cover, width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" />\r
	<meta name="description" content="Ionic Svelte - best of Ionic Svelte and Vite">\r
\r
...
\r
	...
	<link rel="alternate icon" href="/favicon-16x16.png" type="image/png" sizes="16x16">\r
...
\r
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-NNGFLY1HYH"><\/script>\r
	<script>\r
		window.dataLayer = window.dataLayer || [];\r
		function gtag() { dataLayer.push(arguments); }\r
		gtag('js', new Date());\r
\r
		gtag('config', 'G-NNGFLY1HYH');\r
	<\/script>\r
\r
	<title>Ionic + SvelteKit</title>\r
	` + head + "\r\n</head>\r\n\r\n<body>\r\n	<div>" + body + "</div>\r\n</body>\r\n\r\n</html>";
