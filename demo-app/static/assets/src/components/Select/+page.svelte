		...
		<form method="POST" action="/components/Inputs" use:enhance>
			<ion-list>
				...
				<ion-item>
					...
					<ion-select name="gaming" interface="popover">
				...
				<ion-item>
					...
					<ion-select name="notifications" value="notifications" interface="action-sheet">
				...
				<ion-item>
					...
					<ion-select name="os" ok-text="Okay" cancel-text="Nah">
				...
				<ion-item>
					...
					<ion-select value="nirvana" name="music">
				...
				<ion-item>
					...
					<ion-select value="12" name="month">
				...
				<ion-item>
					...
					<ion-select value="1994" name="year">
			...
			<div class="ion-padding">
				<ion-button expand="block" type="submit" class="ion-no-margin"> Submit data </ion-button>
			</div>
		</form>
	</ion-content>
</IonPage>
